...
MAPS_LINKS = {
    ...
    "île Kakazou (#Mayotte)": "À COMPLETER",
    "île des Vainqueurs (Saint-Pierre-et-Miquelon)": "À COMPLETER",
    "île aux Marins (Saint-Pierre-et-Miquelon)": "À COMPLETER",
    "île aux Pigeons (Saint-Pierre-et-Miquelon)": "À COMPLETER",
    "île aux Chiens de l'Est (Saint-Pierre-et-Miquelon)": "À COMPLETER",
    "Saint-Barthélemy": "À COMPLETER",
    "les Petits Saints (Saint-Barthélemy)": "À COMPLETER",
    "les Gros Islets (Saint-Barthélemy)": "À COMPLETER",
    "île Petit Jean (Saint-Barthélemy)": "À COMPLETER",
    "île Fourchue (Saint-Barthélemy)": "À COMPLETER",
    "Saint-Martin": "À COMPLETER",
    "île Tintamarre (Saint-Martin)": "À COMPLETER",
    "îlet Pinel (Saint-Martin)": "À COMPLETER",
    "Archipel de la Société (Polynésie)": "À COMPLETER",
    "Archipel des Tuamotu (Polynésie)": "À COMPLETER",
    "Archipel des Gambier (Polynésie)": "À COMPLETER",
    "Archipel des #Marquises (Polynésie)": "À COMPLETER",
    "Nouvelle-Calédonie": "À COMPLETER",
    "île Ouen (Nouvelle-Calédonie)": "À COMPLETER",
    "îlots Saint-Phalle (Nouvelle-Calédonie)": "À COMPLETER",
    "Wallis-et-Futuna": "À COMPLETER",
    "Terre Adélie": "À COMPLETER",
    "île Claude Bernard (Terre Adélie)": "À COMPLETER",
    "île Jean Rostand (Terre Adélie)": "À COMPLETER",
    "île des Pétrels (Terre Adélie)": "À COMPLETER",
    "îles Curie (Terre Adélie)": "À COMPLETER",
    "îlot des Hydrographes (Terre Adélie)": "À COMPLETER",
    "île Altazin (#Kerguelen)": "À COMPLETER",
    "île Léon Lefèvre (#Kerguelen)": "À COMPLETER",
    "île Ravelo (#Kerguelen)": "À COMPLETER",
    "îlots Simone (#Kerguelen)": "À COMPLETER",
    "île Hould (#Kerguelen)": "À COMPLETER",
    "île de la Possession (#Crozet)": "À COMPLETER",
    "île de l'Est (#Crozet)": "À COMPLETER",
    "île aux Cochons (#Crozet)": "À COMPLETER",
    "îlots des Apôtres (#Crozet)": "À COMPLETER",
    "île des Pingouins (#Crozet)": "À COMPLETER",
    "île Amsterdam": "À COMPLETER",
    "île Saint Paul": "À COMPLETER",
    "île Juan de Nova": "À COMPLETER",
    "atoll Bassas da India": "À COMPLETER",
    "île Europa": "À COMPLETER",
    "îles Glorieuses": "À COMPLETER",
    "île Tromelin": "À COMPLETER",
    "île #Clipperton": "https://maps.app.goo.gl/M8LPcY3p4b7EQBQk9",  # Exemple existant
    "île aux Oeufs (#Clipperton)": "À COMPLETER"
}
